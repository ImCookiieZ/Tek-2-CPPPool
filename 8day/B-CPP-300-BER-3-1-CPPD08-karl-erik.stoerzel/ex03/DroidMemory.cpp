...
DroidMemory::DroidMemory(const DroidMemory &copyFrom)
{
    this->_exp = copyFrom._exp;
    this->_fingerprint = copyFrom._fingerprint;
}
...
{
    return this->_exp == other._exp && this->_fingerprint == other._fingerprint;
}
...
void DroidMemory::addExp(const size_t &exp)
{
    this->_exp += exp;
}