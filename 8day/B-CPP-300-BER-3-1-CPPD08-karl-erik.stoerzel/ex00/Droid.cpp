...
{
    return (this->_id == compareWith._id && this->_energy == compareWith._energy && *this->_status ==
    *compareWith._status);
}

bool Droid::operator!=(const Droid &compareWith) const
{
    return !(this->_id == compareWith._id && this->_energy == compareWith._energy &&
             *this->_status == *compareWith._status);
}
