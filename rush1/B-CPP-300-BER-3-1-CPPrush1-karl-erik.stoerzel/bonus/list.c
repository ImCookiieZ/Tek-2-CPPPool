...
ListClass *add(Object *this, Object *other)
{
    ListClass *list1 = this;
    ListClass *list2 = other;

    if (!this || !other ||
    strcmp(((Class *)list1->type)->__name__, ((Class *)list2->type)
    ->__name__) != 0)
        return NULL;
    ListClass *obj = new(List, 0, list2->type);
    obj->size = list1->size + list2->size;
    obj->head = list1->head;
