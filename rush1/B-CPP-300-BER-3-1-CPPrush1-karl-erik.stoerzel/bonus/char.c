...
CharClass *Char_mul(const Object *this, const Object *other)
{
    ...
    if (this == NULL || other == NULL)
        raise("Null pointer is given");
    else if (strcmp(((Class *)other)->__name__, "Char") == 0) {
        int c = ((CharClass *) this)->c * ((CharClass *) other)->c;
        obj= new(Char, c);
    }
    else if (strcmp(((Class *)other)->__name__, "Int") == 0)
    {
        obj = new(Array, ((IntClass *)other)->x, Char, ((CharClass *)this)->c);
    }
    else if (strcmp(((Class *)other)->__name__, "Float") == 0)
    {
        obj = new(Array, (int)((FloatClass *)other)->x, Char, ((CharClass *)
        this)->c);
    }
    return (obj);
}
